...
$(function () {
  ...
  $('.menu__btn').on('click', function () {
    ...
    if ($('.header').hasClass('active')) {
      ...
      // $('.nav__list_depth').slideUp();
    }
  });

  // nav depth
  $('.nav__item--title').on('click', function () {
    // $('.nav__list_depth').slideUp(300);

    if ($(this).siblings('.nav__list_depth').is(':visible')) {
      console.log('열려있을때 클릭');
      $(this).siblings('.nav__list_depth').slideUp(300);
    } else {
      $(this).siblings('.nav__list_depth').slideDown(300);
    }
  });
